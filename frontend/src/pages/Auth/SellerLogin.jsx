// src/pages/Auth/SellerLogin.jsx
...
const SellerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await authAPI.seller.login(formData);
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600">
              ...
              <Link to="/seller/register" className="text-primary-600 hover:text-primary-700 font-semibold">
                Register here
              </Link>
            </p>
          </div>
