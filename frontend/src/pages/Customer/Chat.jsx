...
import { Send, ArrowLeft, MapPin, Clock } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate('/customer/orders/active')}
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-semibold text-gray-900">
                Chat with {order.seller.businessName}
              </h1>
        ...
        >
            ...
            {messages.length === 0 ? (
              <div className="text-center text-gray-500 py-12">
                ...
                <p className="text-sm mt-2">
                  Coordinate meeting time, location, and other details with the seller.
                </p>
              </div>
            ) : (
          ...
          <div className="border-t border-gray-200 p-4">
            ...
            <div className="mt-3 text-xs text-gray-500">
              <p>💡 Discuss meeting location, time, and product details with the seller</p>
            </div>
          </div>
        </div>
      </div>
